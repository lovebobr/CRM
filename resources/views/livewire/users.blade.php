<div>
    ...
    <div class="container  py-2 ml-2">
        <form  class="flex flex-wrap gap-4 my-1.5">
            ...
            @enderror
            @if($userForUpdate)
                <button type="submit"  wire:click="updateUser"class="text-white bg-pink-300 hover:bg-pink-400 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">Обновить</button>
            @else
                <button type="submit"  wire:click="storeUser"class="text-white bg-pink-300 hover:bg-pink-400 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">Создать</button>
            @endif
            <div >
